...
<html>
	<head>
		...
		<link rel="stylesheet" href="/MenuCss/bootstrap.min.css" />
		<link rel="stylesheet" href="/MenuCss/font-awesome.min.css" />

		<!-- page specific plugin styles -->

		<!-- text fonts -->
		<link rel="stylesheet" href="/MenuCss/fonts.googleapis.com.css" />

		<!-- ace styles -->
		<link rel="stylesheet" href="/MenuCss/ace.min.css" class="ace-main-stylesheet" id="main-ace-style" />

		<!--[if lte IE 9]>
			<link rel="stylesheet" href="assets/css/ace-part2.min.css" class="ace-main-stylesheet" />
		<![endif]-->
		<link rel="stylesheet" href="/MenuCss/ace-skins.min.css" />
		<link rel="stylesheet" href="/MenuCss/ace-rtl.min.css" />
		...
		<script src="/MenuCss/ace-extra.min.js"></script>
			...
			<div class="navbar-container ace-save-state" id="navbar-container">
				<div class="navbar-header pull-left">
					...
					<button class="pull-right navbar-toggle navbar-toggle-img collapsed" type="button" data-toggle="collapse" data-target=".navbar-buttons,.navbar-menu">
						...
						<img src="/MenuCss/user.jpg" alt="Jason's Photo" />
					</button>
					...
					<ul class="nav ace-nav">
						...
						<li class="light-blue dropdown-modal user-min">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								<img class="nav-user-photo" src="/MenuCss/user.jpg" alt="Jason's Photo" />
...
,
		...
		<!--[if !IE]> -->
		<script src="/MenuCss/jquery-2.1.4.min.js"></script>
...
<![endif]-->
		...
		<script src="/MenuCss/bootstrap.min.js"></script>

		<!-- page specific plugin scripts -->

		<!-- ace scripts -->
		<script src="/MenuCss/ace-elements.min.js"></script>
		<script src="/MenuCss/ace.min.js"></script>
